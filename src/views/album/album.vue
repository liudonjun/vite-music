<template>
  <div class="singer-detail">
    <music-list :songs="detailData" :title="title" :pic="pic" :loading="loading"></music-list>
  </div>
</template>

<script lang="ts" setup>
import { ref, computed, onMounted } from 'vue'
import { getplayListDetail, getBannerPlayList } from '@/api/api.ts'
...
const computedSinger = computed(() => {
  ...
  if (singerData && singerData.value) {
    ...
    const obj: any = sessionStorage.getItem('__album__')
